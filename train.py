...
class CausalSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        #  keys , query, value propjections fro all heads
...
class GPT(nn.Module):
    ...
    def forward(self,idx):
        ...
        tok_emb = self.transformer.wte(idx) # postion embeddings of shape (T, n_embd)
        pos_emb = self.transformer.wpe(pos) # token embeddigns of shape (B,T, n_embd)
        x = tok_emb + pos_emb
